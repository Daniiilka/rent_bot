...
init_keyboard.add(types.InlineKeyboardButton(text='Приступим!', callback_data='init'))

start_keyboard = types.InlineKeyboardMarkup()
buttons = [types.InlineKeyboardButton(text='Я сдаю свое жилье', callback_data='start_owner'),
           types.InlineKeyboardButton(text='Я риэлтор', callback_data='start_realtor')]
...
buttons = [
    ...
    types.InlineKeyboardButton(text='Квартира', callback_data='type_apartment'),
